...
class inpBarang1 ( wx.Dialog ):

	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"InsertBarang", pos = wx.DefaultPosition, size = wx.Size( 596,381 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.Selesai = wx.RadioButton( self, wx.ID_ANY, u"Selesai", wx.DefaultPosition, wx.DefaultSize, 0 )
		DialogInser.Add( self.Selesai, 0, wx.ALL, 5 )

		self.Proses = wx.RadioButton( self, wx.ID_ANY, u"Proses", wx.DefaultPosition, wx.DefaultSize, 0 )
		DialogInser.Add( self.Proses, 0, wx.ALL, 5 )
